...
def select_roi_manual(frame, camera_id, window_name="Select ROI"):
    ...
    cv2.setMouseCallback(window_name, mouse_callback, param={"camera_id": camera_id})
